...
export type BlogIndexQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: { nodes: Array<{ fields: Pick<Fields, 'slug'>, frontmatter: Pick<Frontmatter, 'date' | 'title' | 'tags'> }> }, allTagsCsv: { nodes: Array<Pick<TagsCsv, 'id' | 'name' | 'amount'>> } };
